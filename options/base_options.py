...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        """
        parser.add_argument('--dataroot_A', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dataroot_B', required=True,help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
